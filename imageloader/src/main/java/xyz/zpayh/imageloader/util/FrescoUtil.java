package xyz.zpayh.imageloader.util;
...
public class FrescoUtil {
    ...
    public static void setWrapAndResizeImage(@NonNull final SimpleDraweeView view, @NonNull final String path, final int viewWidth){
