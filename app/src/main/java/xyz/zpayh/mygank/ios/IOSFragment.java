...
public class IOSFragment extends BaseFragment implements IOSContract.View{

    @Inject
    IOSContract.Presenter mPresenter;
    ...
    protected void initListener() {
        mRefreshList.setOnRefreshListener(()->mPresenter.loadIOS(1,10));
