...
public class ExtensionPresenter implements ExtensionContract.Presenter, Updatable{
    ...
    public ExtensionPresenter(GankService gankService, ExtensionContract.View view) {
        mView = view;
    ...
    @Override
    public void loadExtension(int page, int num) {
        mRefreshing = true;
        mView.showLoading();
        cancelLoad();

        ResultRepository<GankIoResult> resultRepository = mGankService.getData(API.EXTENSION,page,num);
